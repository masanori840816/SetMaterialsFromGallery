...
struct X509Store_t840  : public Object_t
{
	...
	X509Certificate2Collection_t830 * ___list_2;
	...
	X509Store_t856 * ___store_4;
};
struct X509Store_t840_StaticFields{
	...
	Dictionary_2_t479 * ___U3CU3Ef__switch$mapF_5;
};
