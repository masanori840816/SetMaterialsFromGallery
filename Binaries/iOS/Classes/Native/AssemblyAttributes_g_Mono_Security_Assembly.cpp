...
void g_Mono_Security_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AssemblyCopyrightAttribute__ctor_m2039(tmp, il2cpp_codegen_string_new_wrapper("(c) 2003-2004 Various Authors"), &AssemblyCopyrightAttribute__ctor_m2039_MethodInfo);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m2035(tmp, il2cpp_codegen_string_new_wrapper("Mono.Security.dll"), &AssemblyDescriptionAttribute__ctor_m2035_MethodInfo);
	...
	}
	{
		...
		AssemblyProductAttribute__ctor_m2038(tmp, il2cpp_codegen_string_new_wrapper("MONO CLI"), &AssemblyProductAttribute__ctor_m2038_MethodInfo);
	...
	}
	{
		...
		AssemblyTitleAttribute__ctor_m2034(tmp, il2cpp_codegen_string_new_wrapper("Mono.Security.dll"), &AssemblyTitleAttribute__ctor_m2034_MethodInfo);
	...
	}
	{
		...
		AssemblyKeyFileAttribute__ctor_m3220(tmp, il2cpp_codegen_string_new_wrapper("../mono.pub"), &AssemblyKeyFileAttribute__ctor_m3220_MethodInfo);
