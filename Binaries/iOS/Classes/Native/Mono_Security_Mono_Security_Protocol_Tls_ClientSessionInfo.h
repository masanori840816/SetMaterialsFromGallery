...
struct ClientSessionInfo_t1060  : public Object_t
{
	...
	ByteU5BU5D_t17* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t17* ___masterSecret_5;
};
struct ClientSessionInfo_t1060_StaticFields{
